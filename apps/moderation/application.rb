...
module Moderation
  class Application < Hanami::Application
    configure do # rubocop:disable Metrics/BlockLength
      ...
      #
      layout :application # It will load Moderation::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Moderation::Action is included
      ...
      view.prepare do
        ...
        include Moderation::Assets::Helpers
      end
    end
